...
namespace Vicaria.Infrastructure.Migrations
{
    ...
    [Migration("20260924044142_AddLifeStoryEntriesAndPersonTypeHistory")]
    partial class AddLifeStoryEntriesAndPersonTypeHistory
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Vicaria.Domain.Entities.LifeStoryEntry", b =>
                {
                    ...
                    b.ToTable("historia_vida_entradas", (string)null);
                });
            ...
            modelBuilder.Entity("Vicaria.Domain.Entities.PersonTypeChange", b =>
                {
                    ...
                    b.ToTable("historial_tipo_persona", (string)null);
                });
